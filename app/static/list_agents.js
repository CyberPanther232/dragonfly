document.addEventListener('DOMContentLoaded', function () {
    ...
    // --- SVG Icons for different Operating Systems (with new Linux icon) ---
    const OS_ICONS = {
